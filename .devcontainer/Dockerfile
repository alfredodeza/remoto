...
# Copy the requirements over, create the virtualenv, and install the dependencies onto the virtualenv
# Note it uses '~/venv/' on purpose because vscode automatically detects that and activates it for you
